...
public class ScriptingDefineSymbolsManager : Editor
{
    ...
    [MenuItem("Custom Tools/Set Build to Vive Pro", false, 3)]
    private static void NewMenuOption3() => setPlatformVive();

    [MenuItem("Custom Tools/Log Current Settings", false, 4)]
    ...
    {
        //Set Platform
        string success = EditorUserBuildSettings.SwitchActiveBuildTarget(BuildTargetGroup.Standalone, BuildTarget.StandaloneWindows).ToString();
        ...
        Debug.Log("<color=Yellow>" + "Settings Changed DESKTOP: " + success + colorEnd);
    }

    static void setBuildPlatformHL2()
    {
        ////Set Platform
        //string success = EditorUserBuildSettings.SwitchActiveBuildTarget(BuildTargetGroup.WSA, BuildTarget.StandaloneWindows64).ToString();
        //EditorUserBuildSettings.wsaUWPBuildType = WSAUWPBuildType.D3D;
        //Debug.Log("<color=Yellow>" + "Settings Changed HL2: " + success + colorEnd);
        ...
        Debug.Log("<color=Yellow>" + "SWITCH BUILD TO UWP in player settings" + colorEnd);
    }
    static void setBuildPlatformVive()
    {
        ...
        Debug.Log("<color=Yellow>" + "Settings Changed VIVE: " + success + colorEnd);
    }
